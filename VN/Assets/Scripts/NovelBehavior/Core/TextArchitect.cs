...
public class TextArchitect {
	...
	public void ShowText( string text ) {
		...
		if (tmpro == DialogueSystem._instance.speechText)
			DialogueSystem._instance.targetSpeech = text;
	}
	...
	void Initiate() {
		...
		buildProcess = DialogueSystem._instance.StartCoroutine(Construction());
		activeArchitects.Add(tmpro, this);
	}
	[HideInInspector] public bool isConstructing { get { return buildProcess != null; } }
	[HideInInspector] Coroutine buildProcess = null;
